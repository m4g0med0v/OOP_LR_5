...
# в список,состоящий из словарей заданной структуры; записи должны быть
# упорядочены по номерам поездов; вывод на экран информации о поезде,
...
def main() -> None:
    ...
    try:
        ...
        if args.command == "list":
            ...
            if ans:
                print(
                    f"Поезд №{ans[0]} отправляется в {ans[1]} в {ans[2]}, станция: {ans[3]}."
                )
            else:
